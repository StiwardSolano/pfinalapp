...
const Subject = props => (
  <tr>
    ...
    <td><Rater rating={props.rating.total} total={5} interactive={false}><Heart /></Rater> {props.rating.total} Negativos</td>
    <td>
...
export default class WorstList extends Component {
